...
//       // Try all key variants that may have been saved by different code paths
//       _userId      = prefs.getString('flutter.userId')          ??
//           prefs.getString('user_id')                  ??
//           prefs.getString('userId')                   ?? '';
//       _bookerName  = prefs.getString('flutter.userName')        ??
//           prefs.getString('booker_name')              ??
//           prefs.getString('userName')                 ?? '';
//       _designation = prefs.getString('flutter.userDesignation') ??
...
//     // Also save with plain keys for compatibility with timer_card.dart reads
