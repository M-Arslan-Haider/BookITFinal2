...
// // //       // ✅ FIX: 3 checks sequence mein — har case cover hoga
// // //       // 1. Kotlin alarm se aya clockout (app background thi)
// // //       await _checkForBackgroundClockout();
// // //       // 2. Power off / crash / force kill — same din
// // //       await _checkForMissedClockout();
// // //       // 3. 2-3 din baad app khola
...
// // //       // App resumed — ✅ FIX: sab checks chalao
...
// // //
// // //     // ✅ FIX: Timestamp aur distance parho jo Kotlin ne likhi thi
...
// // //     _mqttLive.value = false;
// // //
// // //     // ── Step 3: ✅ CRITICAL FIX — Attendance API call ────────────
// // //     // Pehle yeh missing tha — sirf reset hota tha, save nahi hota
// // //     // Isliye bookers ka clockout record nahi hota tha
// // //     try {
// // //       await attendanceOutViewModel.fastSaveAttendanceOut(
// // //         clockOutTime:  clockOutTime,
...
// // //       // clockOutPending = true raha rehne do — retry hogi
// // //     }
// // //
// // //     // ── Step 4: UI reset ─────────────────────────────────────────
// // //     await _hardResetAllTimerState();
...
// // //     attendanceViewModel.isClockedIn.value = false;
// // //
// // //     // ── Step 5: Location data sync ───────────────────────────────
// // //     _triggerAutoSync();
// // //
// // //     // ── Step 6: User ko batao ────────────────────────────────────
// // //     if (mounted) {
...
// // //       _showSnack(
// // //         title: snackTitle,
// // //         message: 'Aap auto clock-out ho gaye the. Data save ho gaya.',
// // //         type: _SnackType.warning,
// // //         duration: const Duration(seconds: 6),
// // //       );
// // //     }
...
// // //
// // //   // ─────────────────────────────────────────────────────────────
// // //   // ✅ NEW: Power off / crash / force kill recovery
// // //   // Jab Kotlin alarm fire nahi hua lekin clockin reh gaya
// // //   // ─────────────────────────────────────────────────────────────
// // //   Future<void> _checkForMissedClockout() async {
// // //     final prefs = await SharedPreferences.getInstance();
// // //
// // //     // Agar background clockout pehle hi handle ho gaya to skip
// // //     final hasCriticalEvent =
// // //         (prefs.getBool('has_critical_event_pending') ?? false) ||
// // //             (prefs.getBool('flutter.has_critical_event_pending') ?? false);
// // //     if (hasCriticalEvent) return;
// // //
// // //     // Dono keys check karo — flutter prefix aur bina prefix
// // //     final isClockedIn =
...
// // //
// // //     // Aaj ka clockin hai — miss nahi hua, normal flow
// // //     if (clockInDay == today) return;
// // //
// // //     // Multi-day case _checkForMultiDayMissed handle karega
...
// // //
// // //   // ─────────────────────────────────────────────────────────────
// // //   // ✅ NEW: 2-3+ din baad app khola — multi-day recovery
// // //   // ─────────────────────────────────────────────────────────────
// // //   Future<void> _checkForMultiDayMissed() async {
// // //     final prefs = await SharedPreferences.getInstance();
// // //
// // //     // Agar pehle handle ho gaya to skip
// // //     final hasCriticalEvent =
// // //         (prefs.getBool('has_critical_event_pending') ?? false) ||
// // //             (prefs.getBool('flutter.has_critical_event_pending') ?? false);
// // //     if (hasCriticalEvent) return;
...
// // //
// // //     // Same din ya 1 din — _checkForMissedClockout ne handle kiya
// // //     final daysDiff = todayDay.difference(clockInDay).inDays;
// // //     if (daysDiff <= 1) return;
// // //
// // //     // ── 2+ din ka miss detected ───────────────────────────────────
// // //     final missedClockoutTime = DateTime(
// // //       clockInTime.year, clockInTime.month, clockInTime.day, 23, 58, 0,
// // //     );
// // //     const reason = 'System ClockOut - Midnight Time';
...
// //   }
// //
// //   // ✅ NEW: Android Date & Time settings screen open karo
...
// //
// //   // ══════════════════════════════════════════════════════════════
// //   //  HANDLE CLOCK IN  ✅ UPDATED
// //   // ══════════════════════════════════════════════════════════════
// //
// //   Future<void> _handleClockIn(BuildContext context) async {
// //     debugPrint("🎯 [TIMERCARD] CLOCK-IN STARTED");
// //
// //     // ── STEP 0: Android Automatic Date & Time check ──────────────
// //     final bool autoTimeOn = await _isAutoTimeEnabled();
// //     if (!autoTimeOn) {
// //       debugPrint("⛔ [CLOCK-IN] Auto Date & Time DISABLED — blocking");
// //
// //       // ✅ Still send the record to server with autoTimeEnabled = false
...
// //         autoTimeEnabled: false,          // ← false because auto time is OFF
...
// //         ),
// //       );
// //       return; // ⛔ Clock-in blocked
// //     }
// //
// //     // ── STEP 1: Daily state init ──────────────────────────────────
// //     final prefsCheck = await SharedPreferences.getInstance();
// //     final today = DateFormat('yyyy-MM-dd').format(DateTime.now());
// //     if ((prefsCheck.getString(_kLastDate) ?? '') != today) {
// //       await _initDailyState();
...
// //       debugPrint('✅ [CLOCK-IN] 15-min sync reminder started');
// //
// //       // ── STEP 4: POST to Apex AUTO_TIME_LOG ───────────────────────
// //       final apiResult = await AttendanceTimelogApi.postClockIn(
// //         userId:          userId,
// //         bookerName:      bookerName,
// //         designation:     designation,
...
// //             _triggerAutoSync();
// //             // ✅ Internet aaya — pending timelog records bhi sync karo
...
// //       await repo.postDataFromDatabaseToAPI();
// //
// //       // ✅ Pending timelog records bhi sync karo
...
//       attendanceViewModel.isClockedIn.value = true;
//
//       // ✅ NEW: Register Fake-GPS auto clock-out callback
...
//       debugPrint('🛑 [CLOCK-OUT] MQTT tracking stopped');
//
//       // ✅ NEW: Unregister Fake-GPS callback
...
//   // ══════════════════════════════════════════════════════════════
//
//   // In _handleAutoClockOut method, make sure we clear everything:
//
//   Future<void> _handleAutoClockOut({
//     required String reason,
//     required BuildContext context,
...
//       final prefs = await SharedPreferences.getInstance();
//       await prefs.setBool('isClockedIn', false);
//       await prefs.setBool('flutter.isClockedIn', false); // ✅ Also clear flutter pref
//       await prefs.setDouble('fastClockOutDistance', finalDistance);
//       await prefs.setString('fastClockOutTime', clockOutTime.toIso8601String());
//       await prefs.setBool('clockOutPending', true);
//       await prefs.setBool('hasFastClockOutData', true);
...
//   // ══════════════════════════════════════════════════════════════
//
// // In timer_card.dart, update _checkForBackgroundClockout():
//
//   Future<void> _checkForBackgroundClockout() async {
//     final prefs = await SharedPreferences.getInstance();
//
...
//       debugPrint('✅ [BG CLOCKOUT] Attendance saved successfully');
//
//       // ✅ FIX: Use the reliable SQLite path — no more prefs race condition
...
//     attendanceViewModel.isClockedIn.value = false;
//
//     // ✅ Clear any pending clock-in in prefs
//     await prefs.setBool('isClockedIn', false);
//     await prefs.setBool('flutter.isClockedIn', false);
//     await prefs.remove('clockInTime');
//     await prefs.remove('currentSessionStart');
...
//
//       if (fakeLat == 0.0 && fakeLon == 0.0) {
//         debugPrint('⚠️ [FAKE GPS] No fake GPS coordinates saved, skipping API call');
//         return;
//       }
//
...
//
//       debugPrint('📤 [FAKE GPS] Sending data: user=$userId, fake=($fakeLat,$fakeLon), real=($realLat,$realLon), distance=${distanceKm.toStringAsFixed(3)}km');
//
//       // Get addresses
...
//         Uri.parse('https://cloud.metaxperts.net:8443/erp/valor_trading/fakegpspost/post/'),
//         headers: {'Content-Type': 'application/json'},
//         body: jsonEncode(model),
//       ).timeout(const Duration(seconds: 15));
//
//       if (response.statusCode == 200 || response.statusCode == 201) {
//         debugPrint('✅ [FAKE GPS] Data sent to server successfully');
//         // Clear saved fake GPS data after successful send
//         await prefs.remove('flutter.fake_gps_lat');
//         await prefs.remove('flutter.fake_gps_lon');
//         await prefs.remove('flutter.real_gps_lat');
//         await prefs.remove('flutter.real_gps_lon');
//       } else {
//         debugPrint('⚠️ [FAKE GPS] Server returned ${response.statusCode}: ${response.body}');
//         // Save to local DB for retry
//         await _saveFakeGpsToLocalDb(model);
//       }
//     } catch (e) {
//       debugPrint('❌ [FAKE GPS] Failed to send data: $e');
//       // Save to local DB for retry
//       await _saveFakeGpsToLocalDbFromPrefs(prefs, eventTime);
//     }
//   }
//
