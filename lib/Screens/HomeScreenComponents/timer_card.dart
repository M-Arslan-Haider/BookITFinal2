...
//       await prefs.setBool('hasFastClockOutData', true);
//
//       // ✅ FIX: Set GPX pending flags IMMEDIATELY here (not inside the 5-second timer).
//       // If the app is killed before _scheduleHeavyOperations fires, these flags
//       // survive in SharedPreferences and _triggerAutoSync will process GPX on next open.
//       await prefs.setBool('hasPendingGpxData', true);
...
///remove time chnage auto clockout
import 'dart:async';
import 'dart:io';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
